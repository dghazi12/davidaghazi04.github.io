...
submitToStorage.addEventListener('click', function () {
    ...
    let initialsString = JSON.stringify(initials);

    lsOutput.innerHTML += `${initials} <br />`;
    localStorage.getItem(initials);
    localStorage.setItem("Highscore", initialsString);
    console.log(localStorage);
})
...
//     localStorage.setItem("initials", initialsString);

//     let initialsNormal = JSON.parse(localStorage.getItem("initials"));
//     console.log(initialsString)
// })
...
// Check to see if there is anything being stored in the local storage.
